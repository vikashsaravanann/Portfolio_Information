...
function getHmacSecret() {
    return process.env.BROADCAST_ADMIN_TOKEN || 'fallback-so-it-doesnt-crash';
}
...
function checkBroadcastToken(req) {
    if (!process.env.BROADCAST_ADMIN_TOKEN) {
...
function verifyPassword(password) {
    const expected = process.env.BROADCAST_ADMIN_TOKEN;
